...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            place.ant = self
        else: # there is an ant in the place
            # BEGIN Problem 8b
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        "*** YOUR CODE HERE ***"
        return True if self.ant_contained==None and other.is_container==False else False
        # END Problem 8a
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        while x.exit:
            ...
            if x.ant:
                x.ant.double()
                if x.ant.is_container and x.ant.ant_contained:
